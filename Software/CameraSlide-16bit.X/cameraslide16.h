/* 
 * File:   cameraslide16.h
 * Author: James Dudley
 *
 * Created on May 23, 2015, 11:11 AM
 */

#ifndef CAMERASLIDE16_H
#define	CAMERASLIDE16_H
...
#pragma config OSCIOFNC = OFF           // CLKO Enable Configuration bit (CLKO output signal is disabled on the OSCO pin)
